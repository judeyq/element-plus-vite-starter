<template>
    <div
        ...
        <div
            class="glassmorphism-effect mx-auto max-w-[90vw] w-[320px] transform-gpu rounded-2xl bg-white/80 p-8 shadow-[0_8px_15px_rgba(0,0,0,0.1)] backdrop-blur-2xl transition-all hover:translate-y-[-2px]">
            ...
            <el-form ref="formRef" :model="form" :rules="rules" label-position="left">
                <el-form-item prop="username">
                    <el-input v-model="form.username" placeholder="请输入注册手机号"
                        class="focus:shadow-outline-indigo rounded-md shadow-sm">
                        <template #prefix>
